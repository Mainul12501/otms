            ...
            <div class="row">
                @foreach($courseCategories as $courseCategory)
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <a href="{{ route('course-category', ['category_id' => $courseCategory->id, 'name' => $courseCategory->name]) }}" class="d-block">
                            <div class="category-item category-color-1">
                                <div class="category-item-icon">
                                    @if(isset($courseCategory->image))
                                        <img src="{{ asset($courseCategory->image) }}" alt="{{ $courseCategory->name }}" style="height: 60px; width: 60px" />
                                    @else
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-4 filter-item cat{{ $courseCategory->id }}">
                            <div class="course-item">
                                ...
                                <div class="course-img">
                                    <a href="{{ route('course-details', ['course_id' => $course->id, 'title' => str_replace(' ', '-', $course->title)]) }}"><img src="{{ asset($course->image ?? 'front/assets/img/course/01.jpg') }}" alt="" style="height: 300px;"></a>
                                </div>
                                <div class="course-content">
                                    ...
                                    <a href="{{ route('course-details', ['course_id' => $course->id, 'title' => str_replace(' ', '-', $course->title)]) }}"><h4 class="course-title">{{ $course->title }}</h4></a>
                                    ...
                                    <div class="course-bottom">
                                        <a href="{{ route('course-details', ['course_id' => $course->id, 'title' => str_replace(' ', '-', $course->title)]) }}">
                                            <div class="course-instructor">
                                                <img src="{{ asset($course->user->profile_photo_path ?? 'front/assets/img/course/ins-1.jpg') }}" alt="" style="height: 40px" />
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="instructor-item">
                            <div class="instructor-img">
                                <a href="#"><img src="{{ asset($teacher->profile_photo_path ?? 'front/assets/img/instructor/01.jpg') }}" alt="img" style="height: 150px"></a>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-item">
                            <div class="blog-item-img">
                                <img src="{{ asset($blog->image ?? 'front/assets/img/blog/01.jpg') }}" alt="Thumb">
                            </div>
