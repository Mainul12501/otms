                            ...
                            <div class="row">
                                <div class="col-lg-6 col-xl-4">
                                    ...
                                    <div class="course-img">
                                        <a href="#"><img src="{{ asset($course->image ?? 'front/assets/img/course/01.jpg') }}" alt="" style="height: 255px"></a>
                                    </div>
                                </div>
                                        ...
                                        <div class="course-bottom">
                                            <a href="#">
                                                <div class="course-instructor">
                                                    <img src="{{ asset($course->user->profile_photo_path ?? 'admin/user.png') }}" alt="" />
