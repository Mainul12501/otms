            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('courses.index') }}" class="slide-item">Manage</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Charts</a></li>
                        <li><a href="{{ route('admin.blog-categories.create') }}" class="slide-item"> Create</a></li>
                        <li><a href="{{ route('admin.blog-categories.index') }}" class="slide-item">Manage</a></li>
                    </ul>
                </li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Charts</a></li>
                        <li><a href="{{ route('admin.blogs.create') }}" class="slide-item"> Create</a></li>
                        <li><a href="{{ route('admin.blogs.index') }}" class="slide-item">Manage</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('orders.index') }}" target="_blank">
