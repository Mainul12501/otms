                        ...
                        <div class="d-flex order-lg-2">
                            ...
                            <div class="dropdown d-md-flex profile-1">
                                <a href="#" data-bs-toggle="dropdown" class="nav-link pe-2 leading-none d-flex animate">
												<span>
													<img src="{{ !empty(auth()->user()->profile_photo_path) ? auth()->user()->profile_photo_path : 'https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExeHJvenJneXVhaTN2ODFiOWd2d3MzbHAwdXdqdXV2ajFxdjdwZXNzNyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/Lm5xjVY7wxE9lgAbzN/giphy.gif' }}" alt="profile-user"
